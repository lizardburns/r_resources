...
- [intro to tidymodels](https://www.tidymodels.org/start/)
...
- [ML resources list](https://twitter.com/tivadardanka/status/1440281314398138373?s=11)

# Files/File system
- [rprojroot](https://cran.r-project.org/web/packages/rprojroot/vignettes/rprojroot.html)
- [archiving files](https://archive.r-lib.org/)
...
- [documentation review](https://thisisnic.github.io/docreview/index.html)
- [alternative to hexSticker?](https://www.ddrive.no/post/making-hex-and-twittercard-with-bunny-and-magick/)
...
- [zotero bibliography](https://www.anthonyschmidt.co/post/2021-10-25-a-zotero-workflow-for-r/)
- [websites with distill](https://rstudio.github.io/distill/website.html)
- [trackdown for collaborative document preparation](https://github.com/claudiozandonella/trackdown)
...
- [load test](https://rstudio.github.io/shinyloadtest/)
- [add log-in credentials](https://github.com/PaulC91/shinyauthr)
...
# purrr-ing more
- [crossmap](https://crossmap.rossellhayes.com/reference/xmap.html) - map over all combinations of lists
...
# Text analysis
- [clean text](https://github.com/trinker/textclean)
...
# RAP
- [docker workflow](https://towardsdatascience.com/reproducible-work-in-r-e7d160d5d198)
...
- [metaDigitise](https://github.com/daniel1noble/metadigitise) - a package to extract data from plot images
...
## GitHub
- [organisation READMEs](https://twitter.com/github/status/1438842052117204993)
- [Happy Git with R](https://happygitwithr.com/)
